...
class MainActivity : AppCompatActivity() {
    ...
    var itemList = ArrayList<String>() //Creating the array list for the items. Will require an adapter

    var fileHelper = FileHelper() // allow access to write/read data functions
